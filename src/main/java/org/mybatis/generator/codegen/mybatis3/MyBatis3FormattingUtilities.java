...
public class MyBatis3FormattingUtilities {
    ...
    /**
     * 功能描述:通过introspectedTable对象获得查询字段和别名
     *   例:     id id,
     *           id_card idCard,
     ...
     * @date: 2019/5/8 13:51
     */
public static String getSelectColumns( IntrospectedTable introspectedTable){
    ...
    while (iter.hasNext()){
        ...
        if (introspectedColumn.isIdentity()) {
            ...
            sb.append(""+introspectedColumn.getActualColumnName()+"  "+introspectedColumn.getJavaProperty()+",\n");
    }
    ...
    /**
     * 功能描述:通过introspectedTable对象获得一共有多少符合的字段，无视相同属性
     * @auther: gxz
     * @param:
     * @return:
     * @date: 2019/5/8 13:51
     */
    public static int getSelectColumnsNo( IntrospectedTable introspectedTable){
        Iterator<IntrospectedColumn> iter = introspectedTable.getAllColumns().iterator();
        int result=0;
        while (iter.hasNext()){
            IntrospectedColumn introspectedColumn = iter.next();
    ...
    /**
     * 功能描述:通过introspectedTable对象获得主键类型
     * @auther: gxz
     * @param:
     * @return:
     * @date: 2019/5/8 13:51
     ...
     * @date: 2019/5/8 13:51
     */
    public static String getPrimaryKeyColumnName( IntrospectedTable introspectedTable){
        List<String> result=new ArrayList<>();
        return introspectedTable.getPrimaryKeyColumns().get(0).getActualColumnName();

    }


/**
 * 功能描述:获得插入参数(重庆长护险定制版)
 * @auther: gxz
 * @param:
 * @return:
 * @date: 2019/5/8 10:48
 */
    public static String getCQParameterClause(
            IntrospectedColumn introspectedColumn) {
        return getCQParameterClause(introspectedColumn, null);
    }
/**
 * 功能描述:获得插入参数(重庆长护险定制版)
 * @auther: gxz
 ...
 * @date: 2019/5/8 10:47
 */
    public static String getCQParameterClause( IntrospectedColumn introspectedColumn, String prefix){
